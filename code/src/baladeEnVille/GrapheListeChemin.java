 ...
 * @author Niels ETIEN
 */
public class GrapheListeChemin extends Graphe {

    private Vector<LinkedList<ArcChemin>> L;
    ...
    public GrapheListe(int n) {
        ...
        L = new Vector<LinkedList<ArcChemin>>(n);
        L.setSize(n);
    }

    public void ajouterSommet(Sommet s) {
        if (numerotation.ajouterElement(s)) {
            L.set(numerotation.numero(s), new LinkedList<ArcChemin>());
        }
    }

    public boolean existeArc(Sommet s, Sommet t) {
        for (ArcChemin a : L.get(numerotation.numero(s))) {
    ...
    public void ajouterArc(Sommet s, Sommet t, int val) {
        ...
        L.get(si).addLast(new ArcChemin(s, t, val));
    }

    public void ajouterArc(int i, int j, int val) {
        L.get(i).addLast(new ArcChemin(numerotation.elementAt(i),
    ...
    public void enleverArc(Sommet s, Sommet t) {
        int si = numerotation.numero(s);
        ArcChemin a = null;
        for (ArcChemin aa : L.get(numerotation.numero(s))) {
    ...
    public LinkedList<ArcChemin> voisins(Sommet s) {
...
// recopie dans le même ordre
            LinkedList<ArcChemin> Li = G.L.get(i);
            for (ArcChemin a : L.get(i)) {
                Li.addLast(a);
            }
        }
